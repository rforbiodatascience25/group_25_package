...
The goal of bio.mol.central is to ...

## Installation

You can install the development version of bio.mol.central like so:
...
Import styles (***NOT SUREEE***-I am also not sure, but I think I have improved it):
